          ...
          <div className="navbar8-buttons1">
            ...
            <button className="navbar8-action21 thq-button-animated thq-button-outline">
              <span className="thq-body-small">
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text17">Contact Us</span>
                  </Fragment>
                )}
              </span>
            </button>
...
Navbar8.defaultProps = {
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1500883004191-41545391b020?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNjc5MTAzMXw&ixlib=rb-4.0.3&q=80&w=1080',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1584211970299-a7a65b35e758?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNjc5MTAzMXw&ixlib=rb-4.0.3&q=80&w=1080',
  action1: undefined,
  ...
  page4ImageSrc:
    'https://images.unsplash.com/photo-1705872770640-6571dcfd6bd9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNjc5MTAzMHw&ixlib=rb-4.0.3&q=80&w=1080',
  page2: undefined,
  rootClassName: '',
  link3Url: 'https://www.teleporthq.io',
  page3ImageAlt: 'About Us Image',
  link4: undefined,
  logoAlt: '/mxmedia2mxonly-1500h.jpg',
  linkUrlPage2: 'https://www.teleporthq.io',
  page4: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1554774853-d50f9c681ae2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNjc5MTAzMHw&ixlib=rb-4.0.3&q=80&w=1080',
  page3: undefined,
